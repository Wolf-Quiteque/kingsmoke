              ...
              {currentStep === 3 && (
                <div>
                  ...
                  <form onSubmit={handlePayment}>
                    <div style={{ position: 'relative', minHeight: '100px', marginBottom: '20px' }}>
                      {/* Loading Overlay */}
                      {isLoadingCard && (
                        <div style={{
                          position: 'absolute',
                          ...
                          <i className="fas fa-spinner fa-spin" style={{ fontSize: '32px', color: '#dc143c', marginBottom: '15px' }}></i>
                          <p style={{ color: '#666', margin: 0, fontSize: '14px' }}>Loading secure payment form...</p>
                        </div>
                      )}

                      {/* Card Container - Always present in DOM */}
                      <div
                        id="card-container"
                        style={{
                          minHeight: '100px',
                          opacity: isLoadingCard ? 0 : 1,
