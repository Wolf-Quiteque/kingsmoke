...
function LayoutContent({ children, pathname }) {
  ...
  return (
    ...
    {/* sidebar cart item */}
    <div id="cart-sidebar" className={`xs-sidebar-group info-group info-sidebar ${isCartOpen ? 'isActive' : ''}`} style={{ backgroundImage: 'url(/images/background/page-title.webp)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat'}}>
